      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-16">
        ...
        <section className="mb-20 border border-border rounded-2xl p-6 sm:p-8">
          ...
          <div className="space-y-4">
            {[
              { emoji: "🌍", title: "Global visibility", desc: "Your product in front of makers, early adopters & the global Vibe Coding community" },
              { emoji: "🎯", title: "Real users await", desc: "People actively searching for tools — your next fans are here" },
              { emoji: "🤝", title: "Investor connections", desc: "We actively connect standout makers with VCs, technical collaborators & press" },
            ].map((item, i) => (
